    ...
    <form wire:submit="store">
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <x-input class="w-full" placeholder="Ingrese el código del producto" wire:model="product.sku" />
            </div>

            <div class="mb-4">
                <x-label class="mb-2">Nombre del producto</x-label>
                <x-input class="w-full" placeholder="Porfavor ingrese el nombre del producto" wire:model="product.name" />
            </div>

            <div class="mb-4">
                <x-label class="mb-2">Descripción</x-label>
                <x-textarea class="w-full" placeholder="Porfavor ingrese la descripción del producto" wire:model="product.description" />
            </div>
            ...
            <div class="mb-4">
                ...
                <x-input type="number" step="0.01" class="w-full" placeholder="Porfavor ingrese el precio del producto" wire:model="product.price" />
            </div>
